...
Version  : 1.00
Release  : 14
URL      : https://cpan.metacpan.org/authors/id/M/MA/MARKOV/XML-LibXML-Simple-1.00.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/M/MA/MARKOV/XML-LibXML-Simple-1.00.tar.gz
...
%prep
%setup -q -n XML-LibXML-Simple-1.00
cd %{_builddir}
tar xf %{_sourcedir}/libxml-libxml-simple-perl_0.99-1.debian.tar.xz
cd %{_builddir}/XML-LibXML-Simple-1.00
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/XML-LibXML-Simple-1.00/deblicense/
...
cp %{_builddir}/XML-LibXML-Simple-1.00/deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-XML-LibXML-Simple/f799fb75028ed1c3f97c2836c4d0d9defb473bd7
if test -f Makefile.PL; then
